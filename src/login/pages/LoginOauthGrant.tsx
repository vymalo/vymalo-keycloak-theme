...
// Copied only from https://github.com/keycloakify/keycloakify/blob/main/src/login/pages/LoginOauthGrant.tsx
// and modified to remove the "export default" and the "function LoginOauthGrant" lines.
